...
| 层级 | 文件路径 | 说明 |
|------|----------|------|
| **领域层** | `internal/domain/game/` | 游戏领域实体 |
| | `internal/domain/game/game_definition.go` | 游戏定义 |
| | `internal/domain/game/game_config.go` | 游戏配置 |
| | `internal/domain/game/repository.go` | 仓库接口 |
| **应用层** | `internal/application/game/` | 游戏用例 |
| | `internal/application/game/game_usecase.go` | 游戏业务用例 |
| **基础设施层** | `internal/infrastructure/persistence/game/` | 仓库实现 |
| | `internal/infrastructure/persistence/game/repository.go` | 游戏仓库实现 |
| **接口层** | `internal/interfaces/nakama/match/` | Match Handler |
| | `internal/interfaces/nakama/match/match_handler.go` | 匹配处理器 |
| | `internal/interfaces/nakama/match/texas_match.go` | 德州扑克匹配 |
| **接口层** | `internal/interfaces/nakama/rpc/` | Nakama RPC |
| | `internal/interfaces/nakama/rpc/game_rpc.go` | 游戏 RPC |
