...
export namespace AdminReqDefine {
	...
	export const ConfigSetproxycharge = "/config/setproxycharge"
	export type tConfigSetproxychargeReq = {
		charge: RewardDefine.tProxyCharge,
	}
	export type tConfigSetproxychargeRes = ResBase & {}
    ...
    // 设置用户禁用状态
    export const UserSetuserdisabled = "/user/setuserdisabled"
    export type tUserSetuserdisabledReq = {
        userID: number,
        disabled: boolean,
    }
    export type tUserSetuserdisabledRes = ResBase & {
        loginData: UserDefine.tLoginData,
    }

    // 设置用户禁用状态
    export const UserSetuserlockwithdraw = "/user/setuserlockwithdraw"
    export type tUserSetuserlockwithdrawReq = {
        userID: number,
        lockWithdraw: boolean,
    }
    export type tUserSetuserlockwithdrawRes = ResBase & {}

    // 用户筛选
    // 获取普通用户列表
    export const UserFilterGetnormalusers = "/user/filter/getnormalusers"
    export type tUserFilterGetnormalusersReq = {
        userID?: number,
        userIDs?: number[],
        account?: string,
        nickName?: string,
    ...
    export type tUserFilterGetnormalusersRes = ResBase & {
        users: {
            userID: number,
            search: UserDefine.tUserSearch,
            loginData?: UserDefine.tLoginData,
            loginChannels: UserDefine.tLoginChannel[],
            loginRole?: UserDefine.tLoginRole,
            bag?: ItemDefine.tBag,
    ...
    // 获取代理用户列表
    export const UserFilterGetproxyusers = "/user/filter/getproxyusers"
    export type tUserFilterGetproxyusersReq = {
        userID?: number,
        userIDs?: number[],
        account?: string,
        nickName?: string,
    ...
    export type tUserFilterGetproxyusersRes = ResBase & {
        users: {
            userID: number,
            search: UserDefine.tUserSearch,
            loginData?: UserDefine.tLoginData,
            ...
            bag?: ItemDefine.tBag,
            balance?: LeaderDefine.tBalance,
			proxyCharge?: RewardDefine.tProxyCharge,
        }[],
        count: number,
    }

    // 获取管理员用户列表
    export const UserFilterGetadminusers = "/user/filter/getadminusers"
    export type tUserFilterGetadminusersReq = {
        userID?: number,
        userIDs?: number[],
        account?: string,
        nickName?: string,
    ...
    export type tUserFilterGetadminusersRes = ResBase & {
        users: {
            userID: number,
            search: UserDefine.tUserSearch,
            loginData?: UserDefine.tLoginData,
    ...
    // 获取机器人用户列表
    export const UserFilterGetrobotusers = "/user/filter/getrobotusers"
    export type tUserFilterGetrobotusersReq = {
        userID?: number,
        userIDs?: number[],
        nickName?: string,
        disabled?: boolean,
    ...
    export type tUserFilterGetrobotusersRes = ResBase & {
        users: {
            userID: number,
            search: UserDefine.tUserSearch,
            loginData?: UserDefine.tLoginData,
    ...
    export const ChargeGetwithdrawchainmainaddress = "/charge/getwithdrawchainmainaddress"
    export type tChargeGetwithdrawchainmainaddressReq = {
		chainID?:number,
		withDisabled?:boolean,
        page: number,
        limit: number,
    }
    export type tChargeGetwithdrawchainmainaddressRes = ResBase & {
        datas: ChargeDefine.tWithdrawChainMainAddress[],
    }

    export const ChargeUpdatewithdrawchainmainaddress = "/charge/updatewithdrawchainmainaddress"
    export type tChargeUpdatewithdrawchainmainaddressReq = {
		create?:boolean,
        data: ChargeDefine.tWithdrawChainMainAddress,
    }
    export type tChargeUpdatewithdrawchainmainaddressRes = ResBase & {
        data: ChargeDefine.tWithdrawChainMainAddress,
    }
    
    export const ChargeSetwithdrawchainmainaddressenabled = "/charge/setwithdrawchainmainaddressenabled"
    export type tChargeSetwithdrawchainmainaddressenabledReq = {
        no: number,
        enabled: boolean,
    }
    export type tChargeSetwithdrawchainmainaddressenabledRes = ResBase & {
        data: ChargeDefine.tWithdrawChainMainAddress,
    }
    ...
    // 创建机器人
    export const RobotExtCreaterobot = "/robot/ext/createrobot"
    export type tRobotExtCreaterobotReq = {
        groupID?: number,
        matchID?: number,
        count?: number,
    }
    export type tRobotExtCreaterobotRes = ResBase & {}
