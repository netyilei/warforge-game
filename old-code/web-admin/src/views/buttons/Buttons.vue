              ...
              <CRow class="align-items-center mb-3">
                ...
                <CCol xs>
                  <template v-for="color in [
                    ...
                    <CButton :color="color" :active="state === 'active' ? true : false"
              ...
              <CRow class="align-items-center mb-3">
                ...
                <CCol xs>
                  <template v-for="color in [
                    ...
                    <CButton :color="color" :active="state === 'active' ? true : false"
                      :disabled="state === 'disabled' ? true : false" variant="outline">
                      {{ color.charAt(0).toUpperCase() + color.slice(1) }}
                    </CButton>
                  </template>
                </CCol>
              ...
              <CRow class="align-items-center mb-3">
                ...
                <CCol xs>
                  <template v-for="color in [
                    ...
                    <CButton :color="color" :active="state === 'active' ? true : false"
                      :disabled="state === 'disabled' ? true : false" variant="ghost">
                      <CIcon icon="cil-bell" class="me-2" />
                      {{ color.charAt(0).toUpperCase() + color.slice(1) }}
                    </CButton>
                  </template>
      ...
      <CCard class="mb-4">
        ...
        <CCardBody>
          ...
          <div class="d-flex gap-2 flex-wrap">
            <CButton color="success" @click="Toast.success('操作成功完成！', '成功')">成功 Toast</CButton>
            <CButton color="danger" @click="Toast.error('操作失败，请重试', '错误')">错误 Toast</CButton>
            <CButton color="warning" @click="Toast.warning('请注意这个警告信息', '警告')">警告 Toast</CButton>
            <CButton color="info" @click="Toast.info('这是一条提示信息', '提示')">提示 Toast</CButton>
            <CButton color="primary"
              @click="Toast.custom({ title: '自定义', content: '这是自定义颜色的 Toast', color: '#ff6b6b' })">
              自定义 Toast
            </CButton>
          </div>
        </CCardBody>
...
// Toast 现在是全局可用的，具有完整的类型提示
// 在模板和 script 中都可以使用 Toast.success()、Toast.error() 等方法
