...
export const Module_ChargeConfigAppleCard = new kdmodule.database<ChargeDefine.tChargeAppleCardConfig>({
	db:DB.get(),mainIndexName:"typeID",useMongoIDForIndex:true,indexes:{typeID:1},autoCreateIndexes:false,
	tableName:"t_charge_config_apple_card",
	kvChangeTableName:"t_charge_config_apple_card_changed"
})
...
export const Module_WithdrawChainMainAddress = new kdmodule.database<ChargeDefine.tWithdrawChainMainAddress>({
	db:DB.get(),mainIndexName:"no",useMongoIDForIndex:true,indexes:{no:1},autoCreateIndexes:false,
	tableName:"t_withdraw_chain_main_address",
	kvChangeTableName:"t_withdraw_chain_main_address_changed"
})