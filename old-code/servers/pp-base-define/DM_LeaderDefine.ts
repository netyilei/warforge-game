...
export const Module_UserProxyCharge = new kdmodule.database<RewardDefine.tProxyCharge>({
	db:DB.get(),mainIndexName:"userID",useMongoIDForIndex:true,indexes:{userID:1},autoCreateIndexes:false,
	tableName:"t_user_proxy_charge",
	kvChangeTableName:"t_user_proxy_charge_changed"
})