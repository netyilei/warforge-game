...
export const storageApi = {
  ...
  setDefaultStorage: (id: string) =>
    request<{ success: boolean }>({
      url: `/storage-configs/${id}/default`,
      method: 'PUT'
    }),

  getStorageDrivers: () =>
    request<{ drivers: StorageDriver[] }>({
      url: '/storage-configs/drivers',
      method: 'GET'
    }),
