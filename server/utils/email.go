...
type EmailSender struct {
	Config *models.EmailConfigDTO
}

func NewEmailSender(config *models.EmailConfigDTO) *EmailSender {
...
func (e *EmailSender) Send(to, subject, content string) error {
	...
	switch models.EmailProtocol(e.Config.Protocol) {
	case models.EmailProtocolSMTPS:
		return e.sendWithTLS(addr, auth, from.Address, []string{to}, []byte(msg.String()))
	case models.EmailProtocolSTARTTLS:
...
func SendEmail(config *models.EmailConfigDTO, to, subject, content string) error {
